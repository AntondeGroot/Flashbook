...
org = [
       ...
       'self.m_textCtrlQtext = wx.TextCtrl( self.m_panel32, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( -1,-1 ), 0 )','self.m_textCtrlQtext = wx.TextCtrl( self.m_panel32, wx.ID_ANY, data[2], wx.DefaultPosition, wx.Size( -1,-1 ), 0 )',
