...
class flashcard(gui.MyFrame):
    ...
    def m_OpenFlashcardOnButtonClick( self, event ):
        ...
        with wx.FileDialog(self, "Choose a subject to study",defaultDir=str(self.notesdir),defaultFile = defaultfile, wildcard="*.pkl",style=wx.FD_OPEN | wx.FD_FILE_MUST_EXIST) as fileDialog:
