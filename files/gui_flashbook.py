...
class MyFrame ( wx.Frame ):
	...
	def __init__( self, parent, data ):
		...
		self.m_txtTransfer = wx.TextCtrl( self.panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 400,-1 ), wx.TE_READONLY )
		bSizer47.Add( self.m_txtTransfer, 0, wx.ALL, 5 )
